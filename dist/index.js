...
exports.updateDNS = void 0;
const axios_1 = __importDefault(__nccwpck_require__(6545));
function fetch(data, method, params, zone, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield (0, axios_1.default)(c);
        if (res && res.data && method === 'GET')
            return res.data.result[0];
        if (res && res.data && method === 'PUT')
            return res.data.result;
        return null;
    });
}
function updateDNS(TOKEN, ZONE_ID, CID, RECORD_DOMAIN, RECORD_NAME) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!(TOKEN && ZONE_ID && CID && RECORD_DOMAIN && RECORD_NAME))
            throw new Error(' Params TOKEN && ZONE_ID && CID && RECORD_DOMAIN && RECORD_NAME required');
        try {
            const p = `?name=${RECORD_NAME}.${RECORD_DOMAIN}`;
            const { id } = yield fetch(null, 'GET', p, ZONE_ID, TOKEN);
            if (!id)
            ...
            }, 'PUT', '/' + id, ZONE_ID, TOKEN);
            if (!data)
                throw new Error('Could not update DNS link');
...
const dns_1 = __nccwpck_require__(5619);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log('Update DNSLINK records in Cloudflare finished successfully: ', data.content);
        }
        catch (e) {
